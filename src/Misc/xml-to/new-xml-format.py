...
def fix_key_ids(input_key,output_key):
    with open(input_key, 'r',  encoding='utf-8') as infile, \
        ...
        for row in reader:
            ...
            d = {"Start":token_id,"Sense":bn_synset}
...
lang = "ES"
langauge = "Spanish"
input_xml = f"/Users/jairiley/Desktop/Research/Sense-Projection/data/{langauge}/New_Ids/new-gold-tokens-{langauge}-wSenses.tsv"
output_xml = f"/Users/jairiley/Desktop/Research/Sense-Projection/data/{langauge}/New_Ids/xl-wsd-format-{langauge}.xml"
input_key = f"/Users/jairiley/Desktop/Research/Sense-Projection/data/{langauge}/New_Ids/gold-key-{langauge}.txt"
output_key = f"/Users/jairiley/Desktop/Research/Sense-Projection/data/{langauge}/New_Ids/xl-wsd-key-{langauge}.txt"
